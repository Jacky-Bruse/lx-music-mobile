  ...
  return (
    <View style={styles.main}>
      ...
      <ScrollView style={styles.content} keyboardShouldPersistTaps={'always'}>
        ...
        <Text selectable style={styles.bold} >四、资源使用</Text>
        <Text selectable style={styles.text} >4.1 本项目内使用的部分包括但不限于字体、图片等资源来源于互联网。如果出现侵权可联系本项目移除。{'\n'}</Text>
        <Text selectable style={styles.bold} >五、免责声明</Text>
        ...
        <Text selectable style={styles.bold} >六、使用限制</Text>
        <Text selectable style={styles.text} >6.1 本项目完全免费，且开源发布于 <Text onPress={openHomePage} style={textLinkStyle}>GitHub</Text> 面向全世界人用作对技术的学习交流，本软件不对项目内的技术可能存在违反当地法律法规的行为作保证。</Text>
        ...
        <Text selectable style={styles.bold} >七、版权保护</Text>
        <Text selectable style={styles.text} >7.1 音乐平台不易，请尊重版权，支持正版。{'\n'}</Text>
        <Text selectable style={styles.bold} >八、非商业性质</Text>
        <Text selectable style={styles.text} >8.1 本项目仅用于对技术可行性的探索及研究，不接受任何商业（包括但不限于广告等）合作及捐赠。{'\n'}</Text>
        <Text selectable style={styles.bold} >九、接受协议</Text>
