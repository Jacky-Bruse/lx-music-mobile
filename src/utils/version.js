...
const address = [
  [`https://raw.githubusercontent.com/Jacky-Bruse/${name}/beta/publish/version.json`, 'direct'],
]
...
export const downloadNewVersion = async(version, onDownload = noop) => {
  ...
  const url = `https://github.com/Jacky-Bruse/${name}/releases/download/v${version}/${name}-v${version}-${abi}.apk`
